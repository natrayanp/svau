...
type LayoutRouteId = RouteId | "/" | "/auth" | "/auth/admin" | "/auth/dashboard" | "/auth/profile" | "/permission" | "/permission/analysis" | "/permission/analysis/[role]" | "/permission/roles" | "/permission/roles/[role]" | "/permission/roles/new" | "/permission/users" | "/permission/users/[userId]" | null
type LayoutParams = RouteParams & { role?: string; userId?: string }
