<script lang="ts">
  ...
  import type { Role, PermissionStructure,RolePermissions } from '$lib/permission/stores/types_permission';
  ...
  onMount(() => {
    console.log("inside roleeditpage");
    console.log(roleId);
    initializeRoleData();
  });
...
let distribution: { low: number; medium: number; high: number; critical: number } = getPowerDistribution('mockRoleKey');
                ...
                <div class="space-y-3">
                  ...
                  <div class="space-y-2">
                    <div class="flex items-center justify-between text-sm">
                      ...
                      <span class="font-semibold text-gray-900">{getPowerDistribution().low}</span>
                    </div>
                    <div class="flex items-center justify-between text-sm">
                      <div class="flex items-center space-x-2">
                      ...
                      <span class="font-semibold text-gray-900">{distribution.medium}</span>
                    </div>
                    <div class="flex items-center justify-between text-sm">
                      <div class="flex items-center space-x-2">
                      ...
                      <span class="font-semibold text-gray-900">{distribution.high}</span>
                    </div>
                    <div class="flex items-center justify-between text-sm">
                      <div class="flex items-center space-x-2">
                      ...
                      <span class="font-semibold text-gray-900">{distribution.critical}</span>
                    </div>
                  </div>
                </div>
              {:else}
