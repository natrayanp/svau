<script>
  ...
  ----------------------------------------------------------- */
	function viewRole(roleOrId) {
		selectedRoleId = typeof roleOrId === 'object' ? roleOrId.role_id : roleOrId;
		roleEditMode = 'view';
		roleManagementView = 'edit';
		activeTab = 'roles';
	}

	function editRole(roleOrId) {
		selectedRoleId = typeof roleOrId === 'object' ? roleOrId.role_id : roleOrId;
		roleEditMode = 'edit';
		roleManagementView = 'edit';
		activeTab = 'roles';
	...
	<div class="w-full">
		...
		<div class="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-6">
			<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
				<div>
					<h1
						class="text-2xl lg:text-3xl font-bold text-gray-900 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent"
					>
		...
		{:else}
			...
			<div class="px-4 sm:px-6 lg:px-8 py-6">
				<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
					<div
						class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 lg:p-6 hover:shadow-md transition-all duration-300"
					>
						<div class="flex items-center">
							<div
								class="w-8 h-8 lg:w-12 lg:h-12 bg-blue-100 rounded-xl flex items-center justify-center"
							>
					...
					>
						<div class="flex items-center">
							<div
								class="w-8 h-8 lg:w-12 lg:h-12 bg-green-100 rounded-xl flex items-center justify-center"
							>
								<span class="text-lg">👥</span>
							</div>
							<div class="ml-3 lg:ml-4">
					...
					>
						<div class="flex items-center">
							<div
								class="w-8 h-8 lg:w-12 lg:h-12 bg-purple-100 rounded-xl flex items-center justify-center"
							>
								<span class="text-lg">📦</span>
							</div>
							<div class="ml-3 lg:ml-4">
					...
					>
						<div class="flex items-center">
							<div
								class="w-8 h-8 lg:w-12 lg:h-12 bg-orange-100 rounded-xl flex items-center justify-center"
							>
								<span class="text-lg">🔐</span>
							</div>
							<div class="ml-3 lg:ml-4">
				...
				<!-- Main Content Tabs -->
				<div
					class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-6 lg:mb-8"
				>
								...
								{:else}
									<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
										{#each modules as module}
											<div
												class="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 group"
											>
												<div class="flex items-start justify-between mb-4">
													<div class="flex items-center space-x-3">
														...
														<div>
															<h3
																class="font-bold text-gray-900 group-hover:text-gray-700 transition-colors duration-200"
															>
																{module.name}
															</h3>
